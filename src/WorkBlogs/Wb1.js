...
const Wb1 = () => {
  return (
    <div className="Wbs-main-divs">
      ...
      <br></br>
      <br></br>
      <h1>Topic: Studying API's And Promises</h1>
      <div className="h3-div">
        <h3 className="CBs-h3s">Date: 3/18/24</h3>
        <h3 className="CBs-h3s">Main Thoughts: Hard, Workload, Trying</h3>
      </div>
      <br></br>
      <br></br>
      <br></br>
      ...
      <p className="All-Work-p">
        Hello and welcome to the first Official Blog post of Nick.Blog!<br></br>
        ...
        Doing this with React is a lot easier than what plain JS code can be.<br></br>
