...
const blogs = [
  ...
  {  id: 4, category: 'Random', topic: `My Hobbies`, date: '3/22/24', thoughts: ' Fun, Routine, Enjoyment',
  Body: [
    `The First Random Blog of Nick.Blog! These blogs are going to be about anything that doesn't fit into the previous categories and will help you get to know me just a little bit more. If you don't know me, I'm trying to become a 'front-end web developer.' It's a hard goal for anyone, but my days aren't just spent coding and doing research. So, what do I do when I'm not coding?`,
    `My first hobby is gaming. I used to play games every day, all day, ranging from any title from FPS to MOBA to even farming sims. What mainly got me into gaming was the FPS Call of Duty, which is very popular. Later on, I actually went into a minor league tournament in the game Tom Clancy's Rainbow Six Siege. Gaming is a huge part of my life; it's a place where I feel like I can enter a different 'world' and experience what a person or group of people made with just 1s and 0s. This is mainly the reason I got into coding – to make something that maybe someone else would enjoy. If you are interested in my portfolio, I even made an RPG-like game for people to play.` ,
