...
const Welcome = ({ BlogClick, ExitBlogClick, onBlogs }) => {
  return (
    <div>
      <div className="Header-welcome-div">
        <h1 onClick={ExitBlogClick}>Nick.Blog</h1>
        <div className="list-div">
          <ul className="welcome-list">
            <li onClick={BlogClick}>Most Recent Blog</li>
            <li onClick={ExitBlogClick}>Code Related</li>
