  ...
  return (
    <div className="Cbs-main-divs">
      ...
      {blog.Body.map((paragraph, index) => (
        <p key={index} className="All-coding-p">{paragraph}</p>
      ))}
      <p className="All-coding-p">Thank You For Reading</p>
    </div>
  );
};

export default CblogsTemplates;